...
/**
 * 送信メッセージ一覧画面で使用するデータを格納するためのアクションフォーム
 */
public class FrontListSendedMessageActionForm extends MessageExtendActionForm {
    ...
    public FrontListSendedMessageActionForm() {}
