...
/**
 * 管理画面 申込受付一覧画面で使用するデータを格納するためのアクションフォーム
 */
public class AdminListReceivedEntryActionForm extends EntryExtendActionForm {
    ...
    public AdminListReceivedEntryActionForm() {}
