package admin.actionform.entry;
...
/**
 * 管理画面 申込受付一覧画面の検索で使用するデータを格納するためのアクションフォーム
 */
public class AdminSearchReceivedEntryActionForm extends EntryExtendActionForm {

    private String strEntryId; // 申込ID(文字列型)
    private String strEntrySchoolId; // 申込先スクールID(文字列型)
    private String likeEntrySchoolName; // 申込先スクール名(類似)
    private String strApplicantAccountId; // 申込者アカウントID(文字列型)
    ...
    private String[] entryStatusIdArray; // 申込ステータスIDリスト
    ...
    public AdminSearchReceivedEntryActionForm() {}

    /**
     * strEntryIdを取得する。
     */
    public String getStrEntryId() {
        return strEntryId;
    }
     ...
     * strEntryIdを格納する。
     */
    public void setStrEntryId(String strEntryId) {
        this.strEntryId = strEntryId;
    }

    /**
     * strEntrySchoolIdを取得する。
     */
    public String getStrEntrySchoolId() {
        return strEntrySchoolId;
    }

    /**
     * strEntrySchoolIdを格納する。
     */
    public void setStrEntrySchoolId(String strEntrySchoolId) {
        this.strEntrySchoolId = strEntrySchoolId;
    }
    ...
    /**
     * strApplicantAccountIdを取得する。
     */
    public String getStrApplicantAccountId() {
        return strApplicantAccountId;
    }

    /**
     * strApplicantAccountIdを格納する。
     */
    public void setStrApplicantAccountId(String strApplicantAccountId) {
        this.strApplicantAccountId = strApplicantAccountId;
    }
