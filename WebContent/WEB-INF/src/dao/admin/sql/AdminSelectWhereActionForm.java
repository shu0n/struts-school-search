package dao.admin.sql;

import org.apache.struts.action.ActionForm;

/**
 * 管理者テーブルから取得するレコードの条件に使用するデータを格納するためのアクションフォーム
 */
public class AdminSelectWhereActionForm extends ActionForm {
    ...
    public AdminSelectWhereActionForm() {}
