...
/**
 * スクールテーブルのデータを格納するためのアクションフォーム
 */
public class SchoolActionForm extends ValidatorForm {
    ...
    private Timestamp schoolRegisteredAt; // スクール登録日時
    private Timestamp schoolUpdatedAt; // スクール更新日時
    private String schoolDeleteFlag; // スクール削除フラグ
    private Timestamp schoolDeletedAt; // スクール削除日時

    public SchoolActionForm() {}
    ...
    /**
     * schoolRegisteredAtを取得する。
     */
    public Timestamp getSchoolRegisteredAt() {
        return schoolRegisteredAt;
    }

    /**
     * schoolRegisteredAtを格納する。
     */
    public void setSchoolRegisteredAt(Timestamp schoolRegisteredAt) {
        this.schoolRegisteredAt = schoolRegisteredAt;
    }

    /**
     * schoolUpdatedAtを取得する。
     */
    public Timestamp getSchoolUpdatedAt() {
        return schoolUpdatedAt;
    }

    /**
     * schoolUpdatedAtを格納する。
     */
    public void setSchoolUpdatedAt(Timestamp schoolUpdatedAt) {
        this.schoolUpdatedAt = schoolUpdatedAt;
    }

    /**
     * schoolDeleteFlagを取得する。
     */
    public String getSchoolDeleteFlag() {
        return schoolDeleteFlag;
    }

    /**
     * schoolDeleteFlagを格納する。
     */
    public void setSchoolDeleteFlag(String schoolDeleteFlag) {
        this.schoolDeleteFlag = schoolDeleteFlag;
    }

    /**
     * schoolDeletedAtを取得する。
     */
    public Timestamp getSchoolDeletedAt() {
        return schoolDeletedAt;
    }

    /**
     * schoolDeletedAtを格納する。
     */
    public void setSchoolDeletedAt(Timestamp schoolDeletedAt) {
        this.schoolDeletedAt = schoolDeletedAt;
    }
