...
public class EditAccountConfirmActionTest {
    ...
    public static DbUnitTester dbUnitTester = new DbUnitTester(
            ...
            "setUpDataSet.EditAccountConfirmActionTest.xml") {
        @Override
    ...
    public static class executeTest extends MockStrutsTestCase {
        ...
        private static final String ACTION_PATH = "/editAccountConfirm.do";
        ...
        @Test
        public void testExecuteToForwardSuccessInCaseProfileImageFileAndChangePasswordExist() throws Exception {
            FrontEditAccountActionForm inForm = new FrontEditAccountActionForm();
            ...
            inForm.setSexId(2);
            inForm.setSexName("男性");
            inForm.setBirthDate(Timestamp.valueOf("1990-01-02 00:00:00"));
            inForm.setBirthYear("1990");
            inForm.setBirthMonth("01");
            inForm.setBirthDay("02");
            inForm.setPrefectureId(3);
            inForm.setPrefectureName("北海道");
            inForm.setMailAddress("test@example.com");
            inForm.setProfileImageFile(
                    new GenerateFormFile("updateProfileImage.png", "front/action/account/profileImage.png", 1187));
            ...
            prefectureMap.put(2, "福島県");
            prefectureMap.put(3, "東京都");
        ...
        @Test
        public void testExecuteToInvalid() throws Exception {
            FrontEditAccountActionForm inForm = new FrontEditAccountActionForm();
        ...
        public void testExecuteToForwardRedoInCaseMailAddressExist() throws Exception {
            ...
            inForm.setPrefectureId(3);
            inForm.setPrefectureName("北海道");
            inForm.setMailAddress("exist@example.com");
            inForm.setProfileImageFile(
                    new GenerateFormFile("profileImage.png", "front/action/account/profileImage.png", 1187));
            inForm.setSelfIntroduction("自己紹介です。");
            Map<Integer, String> sexMap = new TreeMap<>();
