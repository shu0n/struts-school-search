...
import front.actionform.message.FrontListSendedMessageActionForm;
import servletunit.struts.MockStrutsTestCase;
import test.db.DbUnitTester;
import test.struts.StrutsTester;

@RunWith(Enclosed.class)
public class ListSendedMessageActionTest {
    ...
    public static DbUnitTester dbUnitTester = new DbUnitTester(
            ...
            "setUpDataSet.ListSendedMessageActionTest.xml") {
        @Override
    ...
    public static class executeTest extends MockStrutsTestCase {
        ...
        private static final String ACTION_PATH = "/listSendedMessage.do";
        ...
        public void testExecuteToForwardSuccessInCaseFirstAccess() {
            ...
            int[] expectedMessageIdArray = {33, 32, 31};
            MessageExtendActionForm expectedForm1 = new MessageExtendActionForm();
            expectedForm1.setMessageId(33);
            expectedForm1.setReplyMessageId(32);
            expectedForm1.setEntryId(8);
            expectedForm1.setSenderAccountId(3);
            expectedForm1.setSenderLastName("田中");
            expectedForm1.setSenderFirstName("三郎");
            expectedForm1.setRecipientAccountId(4);
            expectedForm1.setRecipientLastName("田中");
            expectedForm1.setRecipientFirstName("四郎");
            expectedForm1.setMessageSubject("メッセージ題名3");
            expectedForm1.setMessageBody("メッセージ本文3");
            expectedForm1.setSendedAt(Timestamp.valueOf("2022-01-04 05:06:07.891"));
            expectedForm1.setStrSendedAt("2022/01/04 05:06:07");
            expectedForm1.setOpenedFlag("1");
            expectedForm1.setOpenedAt(Timestamp.valueOf("2022-01-05 06:07:08.912"));
            expectedForm1.setSenderDeleteFlag("0");
            expectedForm1.setSenderFlagUpdatedAt(null);
            ...
            expectedForm2.setRecipientDeleteFlag("1");
            expectedForm2.setRecipientFlagUpdatedAt(Timestamp.valueOf("2022-01-13 14:15:16.891"));
            int expectedTotalForm = 3;
            int expectedTotalPage = 1;
            int expectedCurrentPage = 1;

            FrontListSendedMessageActionForm actual = (FrontListSendedMessageActionForm) getActionForm();
        ...
        public void testExecuteToForwardSuccessInCaseCurrentPageIsSecond() {
            FrontListSendedMessageActionForm frontListSendedMessageForm = new FrontListSendedMessageActionForm();
            ...
            setActionForm(frontListSendedMessageForm);
        ...
        public void testExecuteInCaseLogout() {
            ...
            verifyForwardPath("/login.do?redirectUrl=/listSendedMessage.do");
        }
