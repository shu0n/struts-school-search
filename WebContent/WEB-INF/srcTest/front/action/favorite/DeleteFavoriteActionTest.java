...
import front.actionform.favorite.FrontDeleteFavoriteActionForm;
import servletunit.struts.MockStrutsTestCase;
import test.db.DbUnitTester;
import test.struts.StrutsTester;

@RunWith(Enclosed.class)
public class DeleteFavoriteActionTest {
    ...
    public static DbUnitTester dbUnitTester = new DbUnitTester(
            ...
            "setUpDataSet.DeleteFavoriteActionTest.xml") {
        @Override
    ...
    public static class executeTest extends MockStrutsTestCase {
        ...
        private static final String ACTION_PATH = "/deleteFavorite.do";
        ...
        @Test
        public void testExecuteInCaseDeleteFavoriteSuccessfully() throws Exception {
            ...
            FrontDeleteFavoriteActionForm actual = (FrontDeleteFavoriteActionForm) getActionForm();
            ...
            IDataSet expectedDataSet = new FlatXmlDataSetBuilder().build(getClass().getResourceAsStream(
                    "expectedDataSet.DeleteFavoriteActionTest.testExecuteInCaseDeleteFavoriteSuccessfully.xml"));
        ...
        @Test
        public void testExecuteInCaseNoFavoriteIdExist() throws Exception {
            addRequestParameter("schoolId", "5");
            getSession().setAttribute("logined", "true");
            getSession().setAttribute("accountId", "3");
            actionPerform();

            verifyForwardPath("/viewDetailedSchool.do?schoolId=5");
        }
        ...
        public void testExecuteInCaseLogout() throws Exception {
            ...
            verifyForwardPath("/login.do?redirectUrl=/deleteFavorite.do?schoolId=4");
        }
