...
public class RegisterSchoolConfirmActionTest {
    ...
    public static class executeTest extends MockStrutsTestCase {
        ...
        public void testExecuteToForwardSuccessInCaseRegisterAsAccount() {
            ...
            String expectedRegistrantKindName = "アカウント";
            int expectedRegistrantAccountId = 2;
            ...
            assertThat(actual.getRegistrantKindName(), is(expectedRegistrantKindName));
        ...
        @Test
        public void testExecuteToForwardSuccessInCaseRegisterAsAdmin() {
            AdminRegisterSchoolActionForm inForm = new AdminRegisterSchoolActionForm();
            ...
            String expectedRegistrantKindName = "管理者";
            String expectedStrRegistrantAdminId = "1";
            String expectedSchoolCategoryName = "茶道";
            String expectedSchoolPrefectureName = "山口県";
            BigDecimal expectedSchoolFee = new BigDecimal("4321");
            ...
            assertThat(actual.getRegistrantKindName(), is(expectedRegistrantKindName));
            assertThat(actual.getStrRegistrantAdminId(), is(expectedStrRegistrantAdminId));
            assertThat(actual.getSchoolCategoryName(), is(expectedSchoolCategoryName));
            assertThat(actual.getSchoolPrefectureName(), is(expectedSchoolPrefectureName));
            assertThat(actual.getSchoolFee(), is(expectedSchoolFee));
            assertThat(actual.getSchoolReleaseProprietyName(), is(expectedSchoolReleaseProprietyName));
