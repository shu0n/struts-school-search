...
public class RegisterSchoolInputActionTest {
    ...
    public static class executeTest extends MockStrutsTestCase {
        ...
        public void testExecuteToForwardSuccessInCaseNoParameterExist() {
            ...
            expectedRegistrantKindMap.put("admin", "管理者として登録");
            expectedRegistrantKindMap.put("account", "選択するアカウントとして登録");
            ...
            expectedRegistrantAccountIdList.add(new LabelValueBean("選択してください", ""));
