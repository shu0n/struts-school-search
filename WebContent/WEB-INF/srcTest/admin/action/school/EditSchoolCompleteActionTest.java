...
public class EditSchoolCompleteActionTest {
    ...
    public static class executeTest extends MockStrutsTestCase {
        ...
        public void testFixToForwardFix() {
            AdminEditSchoolActionForm inForm = new AdminEditSchoolActionForm();
            ...
            AdminEditSchoolActionForm actual = (AdminEditSchoolActionForm) getActionForm();
        ...
        public void testEditToForwardEditInCaseDeleteImage() throws Exception {
            ...
            inForm.setRegistrantLastName(null);
            inForm.setRegistrantFirstName(null);
            inForm.setRegistrantLastNameKana(null);
            inForm.setRegistrantFirstNameKana(null);
            ...
            inForm.setStrRegistrantAccountId("61");
            inForm.setDeleteSummaryImageFileFlag(true);
            inForm.setDeleteDetailImage1FileFlag(true);
            inForm.setDeleteDetailImage2FileFlag(true);
            inForm.setDeleteDetailImage3FileFlag(true);
