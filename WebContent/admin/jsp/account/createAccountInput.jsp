...
<section class="container-fluid pt-4" style="width: 90%;">
    <h2>アカウント作成<br class="d-sm-none" />(入力)</h2>
    <html:form action="/createAccountConfirm" enctype="multipart/form-data" onsubmit="return validateBeforeSubmitAccount()">
        <fieldset class="form-group">
            <div class="row">
                <legend class="col-md-3 col-form-label">アカウントステータス<span class="badge badge-warning">必須</span></legend>
                <div class="col-md-9" style="padding-top: calc(0.375rem + 1px);">
                    <%
                    int i = 1;
                    %>
                    <logic:iterate id="accountStatusMap" name="AdminCreateAccountActionForm" property="accountStatusMap">
        ...
        <fieldset class="form-group">
            <div class="row">
                ...
                <div class="col-md-9" style="padding-top: calc(0.375rem + 1px);">
                    ...
                    int j = 1;
                    %>
                    <logic:iterate id="sexMap" name="AdminCreateAccountActionForm" property="sexMap">
                        <div class="form-check form-check-inline">
                            <%
                            // for属性の値を生成する。
        ...
        <div class="form-group row">
            ...
            <div class="col-md-9">
                ...
                <div class="invalid-feedback">8〜16文字の半角英数字で入力してください。</div>
            </div>
        </div>
        <div class="form-group row">
