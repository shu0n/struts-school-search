...
<%@ page import="admin.actionform.school.AdminRegisterSchoolActionForm"%>
<%@ taglib uri="http://struts.apache.org/tags-bean" prefix="bean" %>
<%@ taglib uri="http://struts.apache.org/tags-html" prefix="html" %>
<%
// セッションからアクションフォームを取得する。
AdminRegisterSchoolActionForm inForm = (AdminRegisterSchoolActionForm) session.getAttribute("AdminRegisterSchoolActionForm");
%>
<!DOCTYPE html>
<html lang="ja">
<jsp:include page="../common/head.jsp">
    <jsp:param name="title" value="スクール登録(プレビュー)"/>
</jsp:include>
<body>
...
<section class="container-fluid pt-4" style="width: 90%;">
    ...
    <div>
        <p>
            <strong>公開可否：</strong><bean:write name="AdminRegisterSchoolActionForm" property="schoolReleaseProprietyName"/><br class="d-sm-none">
            <strong>申込可否：</strong><bean:write name="AdminRegisterSchoolActionForm" property="schoolEntryProprietyName"/>
        </p>
    </div>
        <div>
        <p>
            <strong>登録者種別：</strong><bean:write name="AdminRegisterSchoolActionForm" property="registrantKindName"/><br class="d-sm-none">
            <%
            // 登録者種別を判定する。
            if(inForm.getRegistrantAccountId() != 0) {
                // アカウントIDが0以外の場合
            %>
                <strong>登録アカウントID：</strong><bean:write name="AdminRegisterSchoolActionForm" property="strRegistrantAccountId"/>
            <%
            } else {
                // 上記以外の場合
            %>
                <strong>登録管理者ID：</strong><bean:write name="AdminRegisterSchoolActionForm" property="strRegistrantAdminId"/>
            <%
            }
            %>
        </p>
    ...
    <div class="row justify-content-end justify-content-sm-start">
        <div class="col-sm-3 pb-3">
            <div class="card h-100">
                ...
                <div class="card-body">
                    <h5 class="card-title"><bean:write name="AdminRegisterSchoolActionForm" property="schoolName"/></h5>
                    <p class="card-text"><bean:write name="AdminRegisterSchoolActionForm" property="schoolCategoryName"/></p>
                    <p class="card-text"><bean:write name="AdminRegisterSchoolActionForm" property="schoolPrefectureName"/></p>
                    <p class="card-text" style="white-space: pre-wrap;"><bean:write name="AdminRegisterSchoolActionForm" property="schoolSummary"/></p>
                </div>
...
<section class="container-fluid pt-4" style="width: 90%;">
    <h3>詳細画面</h3>
    <h2><bean:write name="AdminRegisterSchoolActionForm" property="schoolName"/></h2>
    <div>
        <p>
            <small><strong>登録：</strong>YYYY年MM月DD日 hh時mm分ss秒</small><br class="d-sm-none">
                ...
                <div class="col-md-6 pt-4">
                    ...
                    <table class="table">
                        <tbody>
                            <tr>
                                <th>カテゴリー</th>
                                <td><bean:write name="AdminRegisterSchoolActionForm" property="schoolCategoryName"/></td>
                            </tr>
                            <tr>
                                <th>費用</th>
                                <td><bean:write name="AdminRegisterSchoolActionForm" property="schoolFee"/> 円</td>
                            </tr>
                            <tr>
                                <th>費用補足</th>
                                <td><bean:write name="AdminRegisterSchoolActionForm" property="supplementaryFee"/></td>
                            </tr>
                            <tr>
                                <th class="text-nowrap">サイト</th>
                                <td>
                                    <a href="<bean:write name="AdminRegisterSchoolActionForm" property="schoolUrl"/>" target="_blank">
                                        <bean:write name="AdminRegisterSchoolActionForm" property="schoolUrl"/>
                                    </a>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <bean:write name="AdminRegisterSchoolActionForm" property="schoolPrefectureName"/>
                                </td>
                            </tr>
                            <tr>
                                <th>登録者</th>
                                ...
                                %>
                                    <td>
                                        <a href="#" class="disabled">
                                            <bean:write name="AdminRegisterSchoolActionForm" property="registrantLastName"/>
                                            <bean:write name="AdminRegisterSchoolActionForm" property="registrantFirstName"/>
                                        </a>
                                    </td>
                                <%
                                }
                ...
                <div class="col-md-12 pt-4">
                    ...
                    <table class="table">
                        <tbody>
                            <tr>
                                <td>
                                    <p style="white-space: pre-wrap;"><bean:write name="AdminRegisterSchoolActionForm" property="schoolDescription"/></p>
                                </td>
                            </tr>
                        </tbody>
                   </table>
                ...
                <div class="col-md-6 pt-4">
                    ...
                    <table class="table">
                        <tbody>
                            <tr>
                                <td>
                                    〒<bean:write name="AdminRegisterSchoolActionForm" property="schoolZipCode1"/>-<bean:write name="AdminRegisterSchoolActionForm" property="schoolZipCode2"/><br>
                                    <bean:write name="AdminRegisterSchoolActionForm" property="schoolPrefectureName"/> <bean:write name="AdminRegisterSchoolActionForm" property="schoolCity"/> <bean:write name="AdminRegisterSchoolActionForm" property="schoolAddress1"/> <bean:write name="AdminRegisterSchoolActionForm" property="schoolAddress2"/>
                                </td>
                            <tr>
                        </tbody>
                    </table>
...
<section class="container-fluid pt-4" style="width: 90%;">
    <html:form action="/registerSchoolComplete" onsubmit="return !isDoubleSubmit()">
        ...
        %>
            <html:hidden property="summaryImageFileName" value="<%=summaryImageFileName %>"/>
        <%
        }
        ...
        for(int i = 1; i < 9; i++) {
            ...
            if(!StringUtils.isEmpty(detailImageFileName)) {
                String property = "detailImage" + i + "FileName";
        %>
