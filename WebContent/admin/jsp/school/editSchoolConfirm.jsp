...
<section class="container-fluid pt-4" style="width: 90%;">
    ...
    <div>
        <p>
            <strong>スクールID：</strong><bean:write name="AdminEditSchoolActionForm" property="schoolId"/>
        </p>
    </div>
    <div>
        <p>
            <strong>公開可否：</strong><bean:write name="AdminEditSchoolActionForm" property="schoolReleaseProprietyName"/><br class="d-sm-none">
            <strong>申込可否：</strong><bean:write name="AdminEditSchoolActionForm" property="schoolEntryProprietyName"/>
        </p>
    </div>
    <div>
        <p>
            <strong>登録者種別：</strong><bean:write name="AdminEditSchoolActionForm" property="registrantKindName"/><br class="d-sm-none">
            <%
            // 登録者種別を判定する。
            if(inForm.getRegistrantAccountId() != 0) {
                // アカウントIDが0以外の場合
            %>
                <strong>登録アカウントID：</strong><bean:write name="AdminEditSchoolActionForm" property="strRegistrantAccountId"/>
            <%
            } else {
                // 上記以外の場合
            %>
                <strong>登録管理者ID：</strong><bean:write name="AdminEditSchoolActionForm" property="strRegistrantAdminId"/>
            <%
            }
            %>
        </p>
    ...
    <div class="row justify-content-end justify-content-sm-start">
        <div class="col-sm-3 pb-3">
            <div class="card h-100">
                ...
                <div class="card-body">
                    <h5 class="card-title"><bean:write name="AdminEditSchoolActionForm" property="schoolName"/></h5>
                    <p class="card-text"><bean:write name="AdminEditSchoolActionForm" property="schoolCategoryName"/></p>
                    <p class="card-text"><bean:write name="AdminEditSchoolActionForm" property="schoolPrefectureName"/></p>
                    <p class="card-text" style="white-space: pre-wrap;"><bean:write name="AdminEditSchoolActionForm" property="schoolSummary"/></p>
                </div>
...
<section class="container-fluid pt-4" style="width: 90%;">
    <h3>詳細画面</h3>
    <h2><bean:write name="AdminEditSchoolActionForm" property="schoolName"/></h2>
        <div>
        <p>
            <small><strong>登録：</strong><bean:write name="AdminEditSchoolActionForm" property="strSchoolRegisteredAt"/></small><br class="d-sm-none">
                    ...
                    <div class="table-responsive">
                        <table class="table">
                            <tbody>
                                <tr>
                                    <th>カテゴリー</th>
                                    <td><bean:write name="AdminEditSchoolActionForm" property="schoolCategoryName"/></td>
                                </tr>
                                <tr>
                                    <th>費用</th>
                                    <td><bean:write name="AdminEditSchoolActionForm" property="schoolFee"/> 円</td>
                                </tr>
                                <tr>
                                    <th>費用補足</th>
                                    <td><bean:write name="AdminEditSchoolActionForm" property="supplementaryFee"/></td>
                                </tr>
                                <tr>
                                    <th class="text-nowrap">サイト</th>
                                    <td>
                                        <a href="<bean:write name="AdminEditSchoolActionForm" property="schoolUrl"/>" target="_blank">
                                            <bean:write name="AdminEditSchoolActionForm" property="schoolUrl"/>
                                        </a>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <bean:write name="AdminEditSchoolActionForm" property="schoolPrefectureName"/>
                                    </td>
                                </tr>
                                <tr>
                                    <th>登録者</th>
                                    ...
                                    %>
                                        <td>
                                            <a href="#" class="disabled">
                                                <bean:write name="AdminEditSchoolActionForm" property="registrantLastName"/>
                                                <bean:write name="AdminEditSchoolActionForm" property="registrantFirstName"/>
                                            </a>
                                        </td>
                                    <%
                                    }
                ...
                <div class="col-md-12 pt-4">
                    ...
                    <table class="table">
                        <tbody>
                            <tr>
                                <td>
                                    <p style="white-space: pre-wrap;"><bean:write name="AdminEditSchoolActionForm" property="schoolDescription"/></p>
                                </td>
                            </tr>
                        </tbody>
                    </table>
                ...
                <div class="col-md-6 pt-4">
                    ...
                    <table class="table">
                        <tbody>
                            <tr>
                                <td>
                                    〒<bean:write name="AdminEditSchoolActionForm" property="schoolZipCode1"/>-<bean:write name="AdminEditSchoolActionForm" property="schoolZipCode2"/><br>
                                    <bean:write name="AdminEditSchoolActionForm" property="schoolPrefectureName"/> <bean:write name="AdminEditSchoolActionForm" property="schoolCity"/> <bean:write name="AdminEditSchoolActionForm" property="schoolAddress1"/> <bean:write name="AdminEditSchoolActionForm" property="schoolAddress2"/>
                                </td>
                            <tr>
                        </tbody>
                    </table>
