...
<section class="container-fluid pt-4" style="width: 90%;">
    ...
    <html:form action="/createAccountComplete" onsubmit="return !isDoubleSubmit()">
        <div class="form-group row">
            ...
            <div class="col-md-3">
                <bean:write name="FrontCreateAccountActionForm" property="lastName"/>
                <bean:write name="FrontCreateAccountActionForm" property="firstName"/>
            </div>
        </div>
        <div class="form-group row">
            <label class="col-md-3 control-label">お名前(フリガナ)<span class="badge badge-warning">必須</span></label>
            <div class="col-md-3">
                <bean:write name="FrontCreateAccountActionForm" property="lastNameKana"/>
                <bean:write name="FrontCreateAccountActionForm" property="firstNameKana"/>
            </div>
        </div>
        <div class="form-group row">
            <label class="col-md-3 control-label">性別</label>
            <div class="col-md-9">
                <bean:write name="FrontCreateAccountActionForm" property="sexName"/>
            </div>
        </div>
        <div class="form-group row">
            <label class="col-md-3 control-label">生年月日</label>
            <div class="col-md-9">
                <logic:notEmpty name="FrontCreateAccountActionForm" property="birthYear">
                    <bean:write name="FrontCreateAccountActionForm" property="birthYear"/>年
                    <bean:write name="FrontCreateAccountActionForm" property="birthMonth"/>月
                    <bean:write name="FrontCreateAccountActionForm" property="birthDay"/>日
                </logic:notEmpty>
            </div>
        </div>
        <div class="form-group row">
            ...
            <div class="col-md-9">
                <bean:write name="FrontCreateAccountActionForm" property="prefectureName"/>
            </div>
        </div>
        <div class="form-group row">
            <label class="col-md-3 control-label">メールアドレス<span class="badge badge-warning">必須</span></label>
            <div class="col-md-9">
                <bean:write name="FrontCreateAccountActionForm" property="mailAddress"/>
            </div>
        </div>
        <div class="form-group row">
            <label class="col-md-3 control-label">自己紹介</label>
            <div class="col-md-9">
                <p style="white-space: pre-wrap;"><bean:write name="FrontCreateAccountActionForm" property="selfIntroduction"/></p>
            </div>
        </div>
        <div class="form-group row">
