<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%@ page import="front.actionform.account.FrontEditAccountActionForm"%>
...
FrontEditAccountActionForm inForm = (FrontEditAccountActionForm) session.getAttribute("FrontEditAccountActionForm");
%>
<!DOCTYPE html>
<html lang="ja">
...
<section class="container-fluid pt-4" style="width: 90%;">
    <h2>アカウント編集(入力)</h2>
    <html:form action="/editAccountConfirm" enctype="multipart/form-data" onsubmit="return validateBeforeSubmitAccount(false)">
        ...
        <fieldset class="form-group">
            <div class="row">
                ...
                <div class="col-md-9" style="padding-top: calc(0.375rem + 1px);">
                    ...
                    int i = 1;
                    %>
                    <logic:iterate id="sexMap" name="FrontEditAccountActionForm" property="sexMap">
