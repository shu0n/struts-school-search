<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%@ page import="front.actionform.message.FrontReplyMessageActionForm"%>
<%@ taglib uri="http://struts.apache.org/tags-bean" prefix="bean" %>
<%@ taglib uri="http://struts.apache.org/tags-html" prefix="html" %>
<%
// セッションからアクションフォームを取得する。
FrontReplyMessageActionForm inForm = (FrontReplyMessageActionForm) session.getAttribute("FrontReplyMessageActionForm");
%>
<!DOCTYPE html>
<html lang="ja">
<jsp:include page="../common/head.jsp">
    <jsp:param name="title" value="メッセージ返信(入力)"/>
</jsp:include>
<body>
<jsp:include page="../common/header.jsp"/>
<section class="container-fluid pt-4" style="width: 90%;">
    <h2>メッセージ返信<br class="d-sm-none"/>(入力)</h2>
    <html:form action="/replyMessageConfirm" onsubmit="return validateBeforeSubmitMessage()">
        <div class="form-group row">
            <label class="col-md-3 col-form-label">返信メッセージID</label>
            <div class="col-md-9" style="padding-top: calc(0.375rem + 1px);">
                <%
                // 受信メッセージ詳細画面へのURLを生成する。
                String messageUrl = "./viewReceivedMessage.do?messageId=" + inForm.getReplyMessageId();
                %>
                <a href="<%=messageUrl %>"><bean:write name="FrontReplyMessageActionForm" property="replyMessageId" scope="session"/></a>
            </div>
        </div>
        <div class="form-group row">
        ...
        <div class="form-group row justify-content-end">
            <div class="col-md-9">
                <%
                // 受信メッセージ詳細画面へのURLを生成する。
                String viewReceivedMessageUrl = "return !isDoubleClick('./viewReceivedMessage.do?messageId=" + inForm.getReplyMessageId() + "')";
                %>
                <html:button property="viewReceivedMessageBtn" value="キャンセル" styleClass="btn btn-secondary" onclick="<%=viewReceivedMessageUrl %>"/>
