...
<section class="container-fluid pt-4" style="width: 90%;">
    <div>
        <%
        // 申込受付一覧画面へのURLを生成する。
        String receivedEntryUrl = "location.href='./listReceivedEntry.do?schoolId=" + inForm.getSchoolId() +"'";
        %>
        <html:button property="receivedEntryBtn" value="申込受付一覧ページへ" styleClass="btn btn-primary" onclick="<%=receivedEntryUrl %>"/>
    </div>
</section>
<section class="container-fluid pt-4" style="width: 90%;">
    <html:form action="/editSchoolConfirm" enctype="multipart/form-data" styleClass="h-adr" onsubmit="return validateBeforeSubmitSchool()">
        <div class="form-group row">
            <label class="col-md-3 col-form-label">スクールID</label>
            <div class="col-md-9">
                <bean:write name="FrontEditSchoolActionForm" property="schoolId"/>
            </div>
        </div>
        <div class="form-group row">
            <label class="col-md-3 col-form-label">登録日時</label>
            <div class="col-md-9" style="padding-top: calc(0.375rem + 1px);">
                <bean:write name="FrontEditSchoolActionForm" property="strSchoolRegisteredAt"/>
            </div>
        </div>
        <div class="form-group row">
            <label class="col-md-3 col-form-label">前回更新日時</label>
            <div class="col-md-9" style="padding-top: calc(0.375rem + 1px);">
                <bean:write name="FrontEditSchoolActionForm" property="strSchoolUpdatedAt"/>
            </div>
        </div>
        <div class="form-group row">
       ...
       <div class="form-group row">
        ...
        <fieldset class="form-group">
            <div class="row">
                ...
                <div class="col-md-9" style="padding-top: calc(0.375rem + 1px);">
                    ...
                    int index = 1;
                    %>
                    <logic:iterate id="schoolReleaseProprietyMap" name="FrontEditSchoolActionForm" property="schoolReleaseProprietyMap">
        ...
        <fieldset class="form-group">
            ...
            <legend class="col-md-3 col-form-label">申込可否<span class="badge badge-warning">必須</span></legend>
                <div class="col-md-9" style="padding-top: calc(0.375rem + 1px);">
                    ...
                    index = 1;
                    %>
                    <logic:iterate id="schoolEntryProprietyMap" name="FrontEditSchoolActionForm" property="schoolEntryProprietyMap">
                        <div class="form-check form-check-inline">
                            <%
                            // for属性の値を生成する。
        ...
        if(!StringUtils.isEmpty(summaryImagePath)) {
            summaryImagePath = request.getContextPath() + summaryImagePath;
        %>
            <div class="form-group row">
        ...
        %>
            ...
            <%
                ...
                if(!StringUtils.isEmpty(detailImagePath)) {
                    detailImagePath = request.getContextPath() + detailImagePath;
            %>
                    <div class="form-group row">
                        <label class="col-md-3 col-form-label"></label>
                        <div class="col-md-4">
        ...
        <div class="form-group row justify-content-end">
            <div class="col-md-9">
                <html:button property="listSchoolBtn" value="キャンセル" styleClass="btn btn-secondary" onclick="return !isDoubleClick('./listRegisteredSchool.do')"/>
