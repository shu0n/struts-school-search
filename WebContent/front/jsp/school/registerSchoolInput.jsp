...
<section class="container-fluid pt-4" style="width: 90%;">
    <h2>スクール登録(入力)</h2>
    <html:form action="/registerSchoolConfirm" enctype="multipart/form-data" styleClass="h-adr" onsubmit="return validateBeforeSubmitSchool()">
       ...
       <div class="form-group row">
        ...
        <fieldset class="form-group">
            <div class="row">
                ...
                <div class="col-md-9" style="padding-top: calc(0.375rem + 1px);">
                    ...
                    int index = 1;
                    %>
                    <logic:iterate id="schoolReleaseProprietyMap" name="FrontRegisterSchoolActionForm" property="schoolReleaseProprietyMap">
        ...
        <fieldset class="form-group">
            ...
            <legend class="col-md-3 col-form-label">申込可否<span class="badge badge-warning">必須</span></legend>
                <div class="col-md-9" style="padding-top: calc(0.375rem + 1px);">
                    ...
                    index = 1;
                    %>
                    <logic:iterate id="schoolEntryProprietyMap" name="FrontRegisterSchoolActionForm" property="schoolEntryProprietyMap">
                        <div class="form-check form-check-inline">
                            <%
                            // for属性の値を生成する。
        ...
        <div class="form-group row justify-content-end">
            <div class="col-md-9">
                <html:button property="cancelEditBtn" value="キャンセル" styleClass="btn btn-secondary" onclick="return !isDoubleClick('./listRegisteredSchool.do')"/>
