...
<%@ page import="front.actionform.school.FrontRegisterSchoolActionForm"%>
<%@ taglib uri="http://struts.apache.org/tags-bean" prefix="bean" %>
<%@ taglib uri="http://struts.apache.org/tags-html" prefix="html" %>
<%
// セッションからアクションフォームを取得する。
FrontRegisterSchoolActionForm inForm = (FrontRegisterSchoolActionForm) session.getAttribute("FrontRegisterSchoolActionForm");
%>
<!DOCTYPE html>
<html lang="ja">
...
<section class="container-fluid pt-4" style="width: 90%;">
    <h2>スクール登録<br class="d-sm-none" />(プレビュー)</h2>
    <div>
        <p>
            <strong>公開可否：</strong><bean:write name="FrontRegisterSchoolActionForm" property="schoolReleaseProprietyName"/><br class="d-sm-none">
            <strong>申込可否：</strong><bean:write name="FrontRegisterSchoolActionForm" property="schoolEntryProprietyName"/>
        </p>
    </div>
</section>
<section class="container-fluid pt-4" style="width: 90%;">
    ...
    <div class="row justify-content-end justify-content-sm-start">
        <div class="col-sm-3 pb-3">
            <div class="card h-100">
                ...
                <div class="card-body">
                    <h5 class="card-title"><bean:write name="FrontRegisterSchoolActionForm" property="schoolName"/></h5>
                    <p class="card-text"><bean:write name="FrontRegisterSchoolActionForm" property="schoolCategoryName"/></p>
                    <p class="card-text"><bean:write name="FrontRegisterSchoolActionForm" property="schoolPrefectureName"/></p>
                    <p class="card-text" style="white-space: pre-wrap;"><bean:write name="FrontRegisterSchoolActionForm" property="schoolSummary"/></p>
                </div>
...
<section class="container-fluid pt-4" style="width: 90%;">
    <h3>詳細画面</h3>
    <h2><bean:write name="FrontRegisterSchoolActionForm" property="schoolName"/></h2>
    <div>
        <p>
                ...
                <div class="col-md-6 pt-4">
                    ...
                    <table class="table">
                        <tbody>
                            <tr>
                                <th>カテゴリー</th>
                                <td><bean:write name="FrontRegisterSchoolActionForm" property="schoolCategoryName"/></td>
                            </tr>
                            <tr>
                                <th>費用</th>
                                <td><bean:write name="FrontRegisterSchoolActionForm" property="schoolFee"/> 円</td>
                            </tr>
                            <tr>
                                <th>費用補足</th>
                                <td><bean:write name="FrontRegisterSchoolActionForm" property="supplementaryFee"/></td>
                            </tr>
                            <tr>
                                <th class="text-nowrap">サイト</th>
                                <td>
                                    <a href="<bean:write name="FrontRegisterSchoolActionForm" property="schoolUrl"/>" target="_blank">
                                        <bean:write name="FrontRegisterSchoolActionForm" property="schoolUrl"/>
                                    </a>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <bean:write name="FrontRegisterSchoolActionForm" property="schoolPrefectureName"/>
                                </td>
                            </tr>
                            <tr>
                                <th>登録者</th>
                                ...
                                %>
                                    <td>
                                        <a href="#" class="disabled">
                                            <bean:write name="FrontRegisterSchoolActionForm" property="registrantLastName"/>
                                            <bean:write name="FrontRegisterSchoolActionForm" property="registrantFirstName"/>
                                        </a>
                                    </td>
                                <%
                                }
                ...
                <div class="col-md-12 pt-4">
                    ...
                    <table class="table">
                        <tbody>
                            <tr>
                                <td>
                                    <p style="white-space: pre-wrap;"><bean:write name="FrontRegisterSchoolActionForm" property="schoolDescription"/></p>
                                </td>
                            </tr>
                        </tbody>
                   </table>
                ...
                <div class="col-md-6 pt-4">
                    ...
                    <table class="table">
                        <tbody>
                            <tr>
                                <td>
                                    〒<bean:write name="FrontRegisterSchoolActionForm" property="schoolZipCode1"/>-<bean:write name="FrontRegisterSchoolActionForm" property="schoolZipCode2"/><br>
                                    <bean:write name="FrontRegisterSchoolActionForm" property="schoolPrefectureName"/> <bean:write name="FrontRegisterSchoolActionForm" property="schoolCity"/> <bean:write name="FrontRegisterSchoolActionForm" property="schoolAddress1"/> <bean:write name="FrontRegisterSchoolActionForm" property="schoolAddress2"/>
                                </td>
                            <tr>
                        </tbody>
                    </table>
